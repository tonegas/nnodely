...
class TimeConcatenate(Relation):
    ...
    def __init__(self, obj1:Relation, obj2:Relation) -> Relation:
        ...
        super().__init__(timeconcatenate_relation_name)
...
class TimePart(Relation):
    ...
    def __init__(self, obj:Relation, i:int|float, j:int|float, name:str =  None, offset:int|float|None = None):
        ...
        name = timepart_relation_name if name is None else name
        self.attrs = {'dim': obj.attrs['dim'], 'tw': [j - i, 0], 'offset': offset}
...
class SamplePart(Relation):
    ...
    def __init__(self, obj:Relation, i:int, j:int, name:str =  None, offset:int|float|None = None):
        ...
        name = samplepart_relation_name if name is None else name
        self.attrs = {'dim': obj.attrs['dim'], 'sw': [j - i, 0], 'offset': offset}
        super().__init__(name, obj.name, **self.attrs)
