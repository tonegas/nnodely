...
#             raise NameError(f"The model '{name}' is already defined.")
#         self.models[name] = model

# MODEL_MANAGER = None

# def set_manager(mg : ModelManager) -> None: 
#     """Register the active ModelManager instance used by Input/Stream helpers."""
#     global MODEL_MANAGER
#     MODEL_MANAGER = mg

# def get_manager() -> ModelManager | None:
#     """Return the currently registered ModelManager or None."""
...
class Modely():
    ...
    def clearTags(self, model= None, tags:str|list|None = None):
        self.mm.models[model]._clear(tags)
